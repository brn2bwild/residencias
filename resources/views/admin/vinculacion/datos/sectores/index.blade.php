<x-app-layout>
  ...
  <x-slot name="slot">
    ...
    <div class="w-full flex justify-end mb-4">
      <a href="{{route('sectores.create')}}" class="btn btn-blue">Nuevo</a>
    </div>
    <table id="sectores" class="w-full text-sm text-left text-gray-500 dark:text-gray-500">
      ...
      <tbody>
        @forelse ($sectores as $sector)
          <tr class="bg-white hover:bg-gray-200 border-b" onclick="window.location='{{route('sectores.edit', $sector)}}'" style="cursor: pointer">
