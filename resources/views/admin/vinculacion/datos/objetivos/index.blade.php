<x-app-layout>
  ...
  <x-slot name="slot">
    ...
    <div class="w-full flex justify-end mb-4">
      <a href="{{route('objetivos.create')}}" class="btn btn-blue">Nuevo</a>
    </div>
    <table id="objetivos" class="w-full text-sm text-left text-gray-500 dark:text-gray-500">
      ...
      <tbody>
        @forelse ($objetivos as $objetivo)
          <tr class="bg-white hover:bg-gray-200 border-b" onclick="window.location='{{route('objetivos.edit', $objetivo)}}'" style="cursor: pointer">
            <td class="px-6 py-4">{{$objetivo->nombre}}</td>
