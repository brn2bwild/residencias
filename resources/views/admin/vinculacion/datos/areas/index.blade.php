<x-app-layout>
  ...
  <x-slot name="slot">
    ...
    <div class="w-full flex justify-end mb-4">
      <a href="{{route('areas.create')}}" class="btn btn-blue">Nuevo</a>
    </div>
    <table id="areas" class="w-full text-sm text-left text-gray-500 dark:text-gray-500">
      ...
      <tbody>
        @forelse ($areas as $area)
          <tr class="bg-white hover:bg-gray-200 border-b" onclick="window.location='{{route('areas.edit', $area)}}'" style="cursor: pointer">
