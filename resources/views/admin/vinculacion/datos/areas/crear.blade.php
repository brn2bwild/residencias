      ...
      <div class="px-4 py-5 bg-white sm:p-6">
        <div class="grid grid-cols-5 gap-4">
          <div class="col-span-6 sm:col-span-2">
            <label for="nombre" class="block text-sm font-medium text-gray-700">Nombre del área de conocimiento</label>
          ...
          <div class="col-span-6 sm:col-span-3">
            <label for="descripcion" class="block text-sm font-medium text-gray-700">Descripción del área de conocimiento</label>
