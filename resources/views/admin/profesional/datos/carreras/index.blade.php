<x-app-layout>
  ...
  <x-slot name="slot">
    ...
    <div class="w-full flex justify-end mb-4">
      <a href="{{route('carreras.create')}}" class="btn btn-blue">Nueva</a>
    </div>
    <table id="carreras" class="w-full text-sm text-left text-gray-500 dark:text-gray-500">
      ...
      <tbody>
        @forelse ($carreras as $carrera)
          <tr class="bg-white hover:bg-gray-200 border-b" onclick="window.location='{{route('carreras.edit', $carrera)}}'" style="cursor: pointer">
